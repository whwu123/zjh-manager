...
<!-- 				<a href="javascript:;" onclick="datadel()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a>  -->
				<a href="javascript:;" onclick="my_affix_add('添加附件','${pageContext.request.contextPath}/affix/add_affix.html','','400')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加附件</a> </span>

...
<section class="Hui-article-box">
	...
	<div class="Hui-article">
		<article class="cl pd-20">
			<div class="text-c">
				<form action="${pageContext.request.contextPath}/case/list.html" method="post" id="form1">
					...
					<input type="text" class="input-text" style="width:250px" placeholder="输入案例名称" name="keyWord" value="${keyWord}">
			...
			<div class="mt-20">
				...
				<thead>
					<tr><th scope="col" colspan="9">案例列表</th></tr>
					<tr class="text-c">
				...
				<c:forEach var="obj" items="${pageInfo.list}">
					<tr class="text-c">
						...
						<td class="td-manage">
							<a title="编辑" href="javascript:;" onclick="select('案例编辑','${pageContext.request.contextPath}/case/select.html?id=${obj.id}','','')"  class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a> 
...
function del(obj,id){
	layer.confirm('确认要删除吗？',function(index){
		...
		$.ajax({
			url:"${pageContext.request.contextPath}/case/delete.shtml",
            type:"post",
            data:{id:id},
